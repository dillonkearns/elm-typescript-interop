                ...
                """
{
    ...
    "elm-version": "0.18.0"
              ...
              """
                    |> Decode.decodeString ElmProjectConfig.decoder
                    |> Expect.equal
                        (Err "I ran into a `fail` decoder: Unsupported elm-version value: `0.18.0`. I only support the exact values [\"0.18.0 <= v < 0.19.0\", \"0.19.0\", \"0.19.1\"].")
        , test "Elm 0.19 config with 0.19.0" <|
            \() ->
                """
{
    "type": "application",
    ...
    "test-dependencies": {
        ...
        , test "Elm 0.19 config with 0.19.1" <|
            \() ->
                """
{
    "type": "application",
